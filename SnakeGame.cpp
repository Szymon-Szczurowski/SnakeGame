...
void loop(void)
    ...
    while(x < 500){
        ...
        placeFood();               
        eat();            
        cout <<  BHGRN << name << " points: " << NC  << score << endl; 
...
int main(){
    ...
    int save = initMenu(); 
     ...
     if(save){
        ...
        if(infile.good()) infile >> length >> score >> name;
        infile.close();
    }else {
        promptName();
    }
